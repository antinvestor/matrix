...
require (
	...
	github.com/antinvestor/apis/go/device v1.47.11
	github.com/antinvestor/apis/go/notification v1.47.11
	github.com/antinvestor/apis/go/partition v1.47.11
	github.com/antinvestor/apis/go/profile v1.47.11
