...
require (
	...
	buf.build/gen/go/antinvestor/presence/protocolbuffers/go v1.36.8-20250520083445-2d0e51ca1296.1
	buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go v1.36.8-20250425153114-8976f5be98c1.1
