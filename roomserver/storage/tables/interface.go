...
type Rooms interface {
	...
	SelectRoomVersionsForRoomNIDs(ctx context.Context, roomNIDs []types.RoomNID) (map[types.RoomNID]gomatrixserverlib.RoomVersion, error)
...
type Published interface {
	UpsertRoomPublished(ctx context.Context, roomID, appserviceID, networkID string, published bool) error
	SelectPublishedFromRoomID(ctx context.Context, roomID string) (published bool, err error)
	SelectAllPublishedRooms(ctx context.Context, networkID string, published, includeAllNetworks bool) ([]string, error)
}
