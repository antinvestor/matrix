...
func mustCreateInviteTable(ctx context.Context, svc *frame.Service, t *testing.T) tables.Invites {
	t.Helper()

	cm := migrateDatabase(ctx, svc, t)
	return postgres.NewPostgresInvitesTable(cm)
}
...
func TestInviteTable(t *testing.T) {
	test.WithAllDatabases(t, func(t *testing.T, testOpts test.DependancyOption) {
		...
		tab := mustCreateInviteTable(ctx, svc, t)
