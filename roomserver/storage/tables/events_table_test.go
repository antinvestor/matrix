...
func mustCreateEventsTable(ctx context.Context, svc *frame.Service, t *testing.T, _ test.DependancyOption) tables.Events {
	t.Helper()
...
func Test_EventsTable(t *testing.T) {
	...
	test.WithAllDatabases(t, func(t *testing.T, testOpts test.DependancyOption) {
		...
		tab := mustCreateEventsTable(ctx, svc, t, testOpts)
...
func TestRoomsWithACL(t *testing.T) {
	...
	test.WithAllDatabases(t, func(t *testing.T, testOpts test.DependancyOption) {
		...
		eventStateKeys := mustCreateEventTypesTable(ctx, svc, t, testOpts)

		eventsTable := mustCreateEventsTable(ctx, svc, t, testOpts)
