...
type RelayQueue interface {
	...
	InsertQueueEntry(ctx context.Context, transactionID gomatrixserverlib.TransactionID, serverName spec.ServerName, nid int64) error
	...
	// successful.
	DeleteQueueEntries(ctx context.Context, serverName spec.ServerName, jsonNIDs []int64) error
	...
	SelectQueueEntries(ctx context.Context, serverName spec.ServerName, limit int) ([]int64, error)
	...
	SelectQueueEntryCount(ctx context.Context, serverName spec.ServerName) (int64, error)
}
